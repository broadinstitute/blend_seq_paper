...
workflow VgCallPrime {
    ...
    output {
        File regenotyped_vcf_gz = VgCallPrimeImpl.regenotyped_vcf_gz
        File regenotyped_tbi = VgCallPrimeImpl.regenotyped_tbi
    }
}
